...
const [adminpassword,setAdminPassword]=useState("");
  ...
  try {
    const response = await axios.post(api.baseurl+"/userLogin", data);
  ...
  const adminlogin = async() => {
    ...
    try {
      console.log("enter");
      const response = await axios.post(api.baseurl+"/login", data);
      // console.log(response.data,"userid")
      ...
      {lo && <Loadingpage/>}
        ...
        <div className="signup-page">
          <div className="image-div">
            <img src={image.signupimg} width="100%" className="sign-up-img" alt="signu"/>
          </div>
