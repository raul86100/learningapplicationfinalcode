...
function Streaks(props) {
  ...
  const streakapi=async()=>{
    await axios.get(`${api.baseurl}/GetLoginStreakforParticularUser/${localStorage.getItem("Userid")}`,{
      headers: {
  ...
  return (
    <div className="streakcontainer">
      <div className="welcome">
        <img src={images.welcomeimg} className="userimg" alt="userimg"></img>
      ...
      <div className="streak">
        ...
        <div className="circle-container">
          <div><img src={streak}   width="100px" alt="str"/> </div> <div className="streakcount" ><p className="scount">{streakref.current}</p><div><p>day Streaks</p></div></div>    </div>
          <span>
